...
class OnboardingAddPaymentAccounts extends GetView<OnboardingController> {
  const OnboardingAddPaymentAccounts({super.key});
            ...
            child: Column(
              ...
              children: [
                Container(
                  ...
                  child: Text('Step 1 of 3', style: AppTextStyle.labelS),
                ),
                Text(
                ...
                Text(
                  '''Start by adding the accounts you use for everyday finances.''',
                    ...
                    Padding(
                      ...
                      child: Obx(
                        () => Row(
                          children: [
                            const Expanded(
                              child: Text('Your payment accounts'),
                            ),
                            Text(
                              '${networthController.cashAndBankAccounts.length} added',
                            ),
                          ],
                        ),
                      ),
          ...
          AppSection(
            child: Obx(
              () => Column(
                ...
                children: [
                  AppButton(
                    text: networthController.hasPaymentAccounts
                        ? 'Add another account'
                        : 'Add my first payment account',
                    onTap: () {
                      // Get.toNamed(Routes.ONBOARDING_LEARN_WITH_ASCEND_INTRO);
                    },
                  ),

                  if (networthController.hasPaymentAccounts)
                    Column(
                      spacing: 8,
                      children: [
                        AppButton(
                          ...
                          onTap: () {
                            Get.toNamed(
                              Routes.ONBOARDING_LEARN_WITH_ASCEND_INTRO,
                            );
                          },
                        ),
                        Text(
