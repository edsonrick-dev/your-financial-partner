...
class OnboardingAddBudgetPlan extends GetView<OnboardingController> {
  const OnboardingAddBudgetPlan({super.key});
            ...
            child: Column(
              ...
              children: [
                Container(
                  ...
                  child: Text('Step 3 of 3', style: AppTextStyle.labelS),
                ),
                Text('Build your budget', style: AppTextStyle.displayM),

                const SizedBox(height: 12),

                Text(
                  '''Plan where your income should go and account for expenses throughout the year.''',
